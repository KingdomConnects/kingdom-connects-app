(() => {
  ...
  header.innerHTML = `
    <header class="site-header">
      <div class="header-inner">
        <div class="brand">
          <img class="brand-logo" src="img/kingdom-connects-logo.png" alt="Kingdom Connects logo">
          <div class="logo-title">KINGDOM CONNECTS</div>
        </div>

        <div class="header-actions">
          <div class="gear-wrap">
            <button id="settingsBtn" aria-haspopup="menu" aria-expanded="false" title="Display & theme settings">
          ...
          <button class="menu-toggle" id="menuBtn" aria-haspopup="true" aria-expanded="false" aria-controls="navMenu" title="Open menu">
  ...
  footer.innerHTML = `
    <footer class="site-footer">
      <div class="footer-inner">
        ...
        <small>© 2025 Kingdom Connects. All rights reserved.</small>
      </div>
    </footer>
  `;
  ...
  // Font size +/- (changes root var so the whole site scales)
