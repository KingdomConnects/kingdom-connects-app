/* Kingdom Connects — components2.js
   Root-relative header/footer injector (safe version)
   Usage: <script src="/js/components2.js" defer></script>
*/
(() => {
      ...
      <header class="site-header">
        <div class="header-inner">
          <a class="brand" href="${ROOT}index.html" aria-label="Home">
            <img class="site-logo" src="${ROOT}img/kingdom-connects-logo.png" alt="Kingdom Connects logo">
            <h1 class="site-title">Kingdom Connects</h1>
          </a>

          <div class="header-actions">
            <div class="gear-wrap">
              <button id="settingsBtn" class="gear-btn" title="Display & theme settings" type="button">
              ...
              <div id="settingsMenu" role="menu" aria-label="Display & theme settings">
                ...
                <div class="setting-row">
                  ...
                  <div class="font-size-controls">
                    <button type="button" id="fontMinus">–</button>
                    <button type="button" id="fontPlus">+</button>
                  </div>
                </div>
              </div>
            </div>

            <button class="menu-toggle" id="menuBtn" type="button" aria-controls="navMenu">
          ...
          <ul class="nav-links" id="navMenu">
            ...
            <li><a href="${ROOT}business.html">Businesses</a></li>
            <li><a href="${ROOT}submit_business.html">Submit</a></li>
      ...
      <footer class="site-footer">
        <div class="footer-inner">
          <nav class="footer-nav">
            ...
            <a href="${ROOT}business.html">Businesses</a>
            <a href="${ROOT}submit_business.html">Submit</a>
  ...
  const getBase = () => parseFloat(getComputedStyle(html).getPropertyValue("--base-font-size")) || 16;
  const setBase = (px) => {
    html.style.setProperty("--base-font-size", px + "px");
    localStorage.setItem("kc-fontScale", String(px));
  };
